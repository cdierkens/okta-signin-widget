...
describe('v2/BaseLoginRouter', function() {
  ...
  describe('error handling', () => {
    it('should render error message when /interact fails with fake error', async function() {
      ...
      setup({ useInteractionCodeFlow: true, globalErrorFn });
      await testContext.router.render(FormController);
      expect(testContext.router.handleIdxResponseFailure).toHaveBeenCalledWith(FakeIdxClientError);
    ...
    it('should render error message when /interact fails with possible error', async function() {
      ...
      setup({ useInteractionCodeFlow: true, globalErrorFn });
      await testContext.router.render(FormController);
      expect(testContext.router.handleIdxResponseFailure).toHaveBeenCalledWith(UnauthorizedClientError);
